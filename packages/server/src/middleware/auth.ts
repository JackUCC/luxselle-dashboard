/**
 * Auth middleware: verify Firebase ID tokens and enforce roles.
 * requireAuth, requireRole(...), optionalAuth; getAuditFields for createdBy/updatedBy. Supports SKIP_AUTH for dev.
 * @see docs/CODE_REFERENCE.md
 * References: firebase-admin/auth, Express, @shared/schemas (UserRole)
 */
