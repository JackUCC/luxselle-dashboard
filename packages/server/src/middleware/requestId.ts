 ...
 * Adds requestId (from X-Request-Id or generated), startTime, requestLogger (start/end JSON logs), logger, and errorTracker for error budgets.
 * @see docs/CODE_REFERENCE.md
 * References: Express, crypto (randomUUID)
 */
