...
backend_cmd="FIREBASE_USE_EMULATOR=true AI_ROUTING_MODE=dynamic GOOGLE_APPLICATION_CREDENTIALS_JSON='' SUPPLIER_EMAIL_ENABLED=false SKIP_AUTH=true npm run dev --workspace=@luxselle/server"
