  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <h3 className="text-[13px] font-semibold text-lux-800">Auction sites</h3>
      </div>
      <div className="space-y-2">
        {AUCTION_SITES.map((site) => (
          <a
            ...
            className="flex items-center justify-between gap-2 rounded-lg border border-lux-200 bg-white px-3 py-2.5 text-left transition-colors hover:border-violet-200 hover:bg-violet-50/40"
          >
            <div className="min-w-0">
              <span className="block text-[13px] font-medium text-lux-800">{site.name}</span>
              <span className="block text-[11px] text-lux-500">{site.description}</span>
            </div>
