    ...
    return (
        <div className="lux-card p-6 h-full flex flex-col">
            <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-semibold text-gray-900 uppercase tracking-wider text-xs">Market Pricing</h3>
            </div>
            ...
            <div className="space-y-2">
                <p className="text-[10px] font-medium text-gray-400 uppercase tracking-wider mb-2">One-Click Search</p>

                <button
                    onClick={() => openLink(`https://www.google.com/search?tbm=shop&q=${encodeURIComponent(searchTerm)}`)}
                    disabled={!searchTerm}
                    className="w-full flex items-center justify-between p-3 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 hover:border-gray-300 transition-all text-left disabled:opacity-30 disabled:cursor-not-allowed group"
                >
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className="h-4 w-4 flex items-center justify-center font-serif font-bold text-amber-600 bg-amber-50 rounded-sm text-[10px]">V</div>
